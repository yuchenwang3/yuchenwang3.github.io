...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "This is my curriculum vitae. You can download the PDF version below.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-gpt-2-inference-optimization-with-cuda",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%75%63%68%65%6E%77%61%6E%67%30%33%30%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'Github',
